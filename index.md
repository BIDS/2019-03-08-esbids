...
instructor: ["Juan Pablo Carvallo", "Hector Manuel Sanchez Castellanos", "Valeri Vasquez (organizadora)"] # lista de nombres de las instructoras separados por comas y entre corchetes, como ["Hedy Lamarr", "Ada Lovelace", "Madame Curie"]
#helper: ["Valeri Vasquez"]     # lista de nombres de las **helpers** separados por comas y entre corchetes, como ["Carrie Fisher", "Frances Allen", "Margaret Hamilton"]
